...
public class TimekeepingMainUI extends VerticalLayout {
    ...
    Table timekeepingTbl = new Table();
    ...
    public TimekeepingMainUI(int branchId){
        ...
        attendancePeriodFrom.setWidth("100%");
        ...
        attendancePeriodTo.setWidth("100%");
        ...
        timekeepingTable(branchId, null);        
    ...
    public void timekeepingTable(int branchId, final String employeeId){
        this.branchId = branchId;
        ...
        timekeepingTbl.addContainerProperty("to", String.class, null);
        timekeepingTbl.addContainerProperty("lates", Double.class, null);
        timekeepingTbl.addContainerProperty("undertime", Double.class, null);
        timekeepingTbl.addContainerProperty("overtime", Double.class, null);
        timekeepingTbl.addContainerProperty("night differential", Double.class, null);
        timekeepingTbl.addContainerProperty("late (d)", Double.class, null);
        timekeepingTbl.addContainerProperty("undertime (d)", Double.class, null);
        timekeepingTbl.addContainerProperty("overtime (p)", Double.class, null);
        timekeepingTbl.addContainerProperty("night differential (p)", Double.class, null);
        timekeepingTbl.addContainerProperty("wLegal (p)", Double.class, null);
        timekeepingTbl.addContainerProperty("wSecial (p)", Double.class, null);
        timekeepingTbl.addContainerProperty("wdo (p)", Double.class, null);
        timekeepingTbl.addContainerProperty("holiday (p)", Double.class, null);
        
        List<Timekeeping> attendanceList = timekeepingService.getAttendanceByBranchAndEmployee(branchId, employeeId);
        int i = 0;
