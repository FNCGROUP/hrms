 ...
 * @author jet
 */
public class LedgerModule extends VerticalLayout{
    ...
    public LedgerModule(String userRole){
        ...
        comboBoxGrid.setWidth(60, Sizeable.UNITS_PERCENTAGE);
        ...
        comboBoxGrid.addComponent(branchName, 0, 1);
        ...
        comboBoxGrid.addComponent(employeesName, 1, 1);          
